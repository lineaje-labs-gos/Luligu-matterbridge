...
describe('Server clusters and behaviors', () => {
  ...
  */
  ...
  test('ThermostatSuggestion server', async () => {
    ...
    const invalidExpirationRequest = { presetHandle: Uint8Array.from([1]), effectiveTime: nowSeconds, expirationInMinutes: -5 };
    ...
    await thermostatSuggestion.invokeBehaviorCommand('Thermostat', 'removeThermostatSuggestion', { uniqueId: 4 });
    expect(thermostatSuggestion.getAttribute(Thermostat.id, 'thermostatSuggestions')).toHaveLength(2);
